        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('cetaktanggal') }}" class="nav-link">
                                <i class="nav-icon fas fa-sign-out-alt"></i>
