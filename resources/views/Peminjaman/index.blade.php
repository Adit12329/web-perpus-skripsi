    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Daftar Buku Pinjam </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/beranda">Home</a></li>
                            <li class="breadcrumb-item active">Daftar Buku Pinjam</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="content">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            <a href="{{ route('peminjaman.create') }}" class="btn btn-success">Tambah Peminjaman<i
                                                ...
                                                <div class="btn-group">
                                                    @if (auth()->user()->level == 'admin')
                                                        <a class="btn btn-dark"
                                                            href="{{ route('peminjaman.edit', $item->id) }}"><i
